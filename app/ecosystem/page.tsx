      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100 text-purple-800 text-sm font-medium mb-6">
              <Sparkles className="w-4 h-4" /> Live Product
            </div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              AI-powered music and song generation platform.
            </p>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Royal Rhythm AI represents a breakthrough in generative audio. Built by DIKANZ engineers, this platform allows creators to generate high-quality, royalty-free music tracks, complete songs with vocals, and dynamic soundscapes using advanced neural networks. It serves as a prime example of applied AI for our students.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              AI-based legal assistant system.
            </p>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Navigating legal complexities is now more accessible. AI Justice GPT is a specialized Large Language Model fine-tuned on extensive legal corpora. It assists legal professionals and individuals in drafting documents, researching case law, and understanding legal precedents with unprecedented speed and accuracy.
            </p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-3 text-gray-700 font-medium">
                <div className="w-2 h-2 rounded-full bg-blue-500" /> Automated Document Drafting
              </li>
              <li className="flex items-center gap-3 text-gray-700 font-medium">
                <div className="w-2 h-2 rounded-full bg-blue-500" /> Case Law Research & Summarization
              </li>
              <li className="flex items-center gap-3 text-gray-700 font-medium">
                <div className="w-2 h-2 rounded-full bg-blue-500" /> Contract Analysis & Risk Flagging
              </li>
            </ul>
        ...
        <div className="bg-gray-50 rounded-3xl p-12 text-center border border-gray-200">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            These are just the beginning. DIKANZ is continuously incubating new ideas. Our students get front-row seats and active participation opportunities in building the next generation of DIKANZ products.
          </p>
        </div>
